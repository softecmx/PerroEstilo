...
public class ElementListViewConsultarPedidos {
    ...
    public ElementListViewConsultarPedidos(String ordenPedido, String statusPedido, String totalPedido, String idusuario) {
        this.ordenPedido = ordenPedido;
        this.statusPedido = statusPedido;
        this.totalPedido = totalPedido;
    ...
    public ElementListViewConsultarPedidos( String producto, String unitario, String cantidad, String subtotal, String imgProducto) {
