...
public class ListAdapterVerEnviosInterna extends ArrayAdapter<ElementListViewVerEnvios> {
    ...
    public ListAdapterVerEnviosInterna(Activity activity, ArrayList<ElementListViewVerEnvios> arrayList, Context context) {
