...
public class ListAdapterConsultarPedidosinterna extends ArrayAdapter<ElementListViewConsultarPedidos> {
    ...
    public ListAdapterConsultarPedidosinterna(Activity activity, ArrayList<ElementListViewConsultarPedidos> arrayList, Context context) {
